...
/**
 * BuddyPress Like Ultimate Functions.
 *
 ...
 */
  ...
  */
 function bplike_ult_has_directory() {
 ...
 * @uses apply_filters() To call the 'bplike_ult_likes_get_user_likes' hook.
 *
 ...
 */
function bplike_ult_likes_get_user_likes( $user_id = 0 ) {
	 ...
	 */
	return apply_filters( 'bplike_ult_likes_get_user_likes', $likes );
}
 ...
 * @since 0.4
 *
 * @uses BPLIKE_ULT_LIKES::total_liked_count() {@link BPLIKE_ULT_LIKES}
 ...
 */
function bplike_ult_total_likes_for_user( $user_id = 0 ) {
	...
	return BPLIKE_ULT_LIKES::total_liked_count( $user_id );
}


function bp_like_ult_pass_members_query_to_core(){
	global  $bp_like_ult_members_display_query;
	return $qs .=  $bp_like_ult_members_display_query;
}
