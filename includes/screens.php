<?php
/**
 * BuddyPress Like Ultimate Screens.
 *
 ...
 * @uses do_action() To call the 'bplike_ult_activity_screen_likes' hook.
 * @uses bp_core_load_template()
 * @uses apply_filters() To call the 'bplike_ult_activity_template_like_activity' hook.
 */
function bplike_ult_activity_screen_likes() {

	/**
	 * Fires right before the activity loops starts.
	 * @since 0.4
	 */
	 add_filter( 'bp_ajax_querystring', 'bplike_ult_filter_all_likes', 999 );
	 ...
	 * @since 0.4
	 */
	do_action( 'bplike_ult_activity_screen_likes' );
	 ...
	 */
	bp_core_load_template( apply_filters( 'bplike_ult_activity_template_like_activity', 'members/single/plugins' ) );
}

function bplike_ult_screen_likes() {
	/**
	 * Fires before the loading of a single group's page.
	 *
	 * @since 1.0.0
	 */
	do_action( 'bplike_ult_screen_likes' );
    
    add_action( 'bp_template_content', 'bplike_ult_temp_output' );
	 ...
	 */
	bp_core_load_template( apply_filters( 'bplike_ult_template_likes', 'members/single/plugins' ) );
}

function bplike_ult_temp_output() {
